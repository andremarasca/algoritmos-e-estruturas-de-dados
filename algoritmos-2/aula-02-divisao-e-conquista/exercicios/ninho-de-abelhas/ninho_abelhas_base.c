/*
 * Simulador para o exercício de localização de um ninho de abelhas.
 *
 * Complete somente a função locate_nest.
 *
 * Compilação:
 * gcc -std=c17 -Wall -Wextra -Wpedantic ninho_abelhas_base.c -o ninho_abelhas
 */
...
static int locate_nest(int begin, int end) {
    /* TODO: implemente a redução sucessiva do intervalo. */
    (void)begin;
    (void)end;
    return -1;
}
